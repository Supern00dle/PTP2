...
public class BVSimulation extends Observable {
  ...
  private class SimulationsThread extends Thread {
    @Override
    public void run() {
      while(!isInterrupted()) {
        simulationsSchritt();
  ...
  private SimulationsThread simThread;
  /**
  ...
  public void starteSimThread() {
    simThread = new SimulationsThread();
    simThread.start();
  }
  
  public void beendeSimThread() {
    simThread.interrupt();
  }
}
